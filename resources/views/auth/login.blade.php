...
<head>
    ...
    <link href="{{ url('assets/ruangAdmin/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet"
        type="text/css">
    <link href="{{ url('assets/ruangAdmin/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet"
        type="text/css">
    <link href="{{ url('assets/ruangAdmin/css/ruang-admin.min.css') }}" rel="stylesheet">
</head>
