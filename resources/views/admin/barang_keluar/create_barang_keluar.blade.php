                    ...
                    <div class="box-barang">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Jumlah</label>
                                    <input data-index="1"  type="number"  id="jumblah" min="1" value="" class="form-control">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input readonly type="number" id="jumblah_sebelumnya" min="1" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
...
//     })
    ...
    //                             <div class="form-group">
    //                                 <label>Jumlah</label>
    //                                 <input data-index="${index}" required type="number" name="databarang[${index}]" id="jumblah" min="1" value="" class="form-control">
    //                                 <span class="alert-barang-kosong text-danger"></span>
    //                             </div>
    //                         </div>
    //                         <div class="col-md-2">
    //                             <div class="form-group">
    //                                 <label>Sebelumnya</label>
    //                                 <input readonly type="number" name="databarang[${index}]" id="jumblah_sebelumnya${index}" min="1" class="form-control">
    //                             </div>
    //                         </div>
    //                         <div class="col-md-2">
    //                             <div class="form-group">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.btn-add-barang', function(){
            ...
            const jumlahMasuk = $('#jumblah').val();
            const stokSebelumnya = $('#jumblah_sebelumnya').val();
