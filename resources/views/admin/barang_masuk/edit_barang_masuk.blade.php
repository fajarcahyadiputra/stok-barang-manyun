            ...
            <form id="formEditData" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="type" required  value="{{$barangmasuk->no_surat_jalan}}" name="no_surat_jalan" id="no_surat_jalan" class="form-control">
                    </div>
                    <div class="form-group">
                        ...
                        <select required name="id_barang" id="id_barang" class="form-control">
                            ...
                            @foreach ($barang as $br)
                             <option {{$barangmasuk->id_barang == $br->id?'selected':''}} value="{{$br->id}}">{{$br->nama_barang}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="id_supplier" id="id_supplier" class="form-control">
                            ...
                            @foreach ($supplier as $sup)
                             <option {{$barangmasuk->id_supplier == $sup->id?'selected':''}} value="{{$sup->id}}">{{$sup->nama}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="penerima">Penerima</label>
                        <input type="type" name="penerima" id="penerima" value="{{$barangmasuk->penerima}}" class="form-control">
                    </div>
                    <div class="form-group">
